...
HandleCollectBulletPackage::~HandleCollectBulletPackage()
{
    for (BulletPackage* package : bulletPackages) 
    {
        delete package;
    }
    bulletPackages.clear();
}
HandleCollectBulletPackage::HandleCollectBulletPackage(Entity& Player)
{
    this->Player = &Player;
...
void HandleCollectBulletPackage::update(vector<BulletPackage*> &Packages)
{
